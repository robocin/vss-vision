...
CameraConfigurationDialog::CameraConfigurationDialog(QWidget* parent) :
  ...
  ui->exposureAutoPriority_checkBox->setChecked(
      this->_camera->getExposureAutoPriority().currentValue);
  ui->exposureAuto_value_label->setText(
      QString::number(this->_camera->getExposureAuto().currentValue));
  ui->exposure_value_label->setText(
      QString::number(this->_camera->getExposureAbsolute().currentValue));
  ui->blacklight_value_label->setText(
      QString::number(this->_camera->getBlacklightComp().currentValue));
  ui->white_balance_auto_checkBox->setChecked(this->_camera->getWhiteBalanceAuto().currentValue);
  ui->white_balance_value_label->setText(
      QString::number(this->_camera->getWhiteBalance().currentValue));
  ...
  ui->horizontalSlider_exposure->setSliderPosition(
      this->_camera->getExposureAbsolute().currentValue);
  ...
  ui->horizontalSlider_exposureAuto->setSliderPosition(
      this->_camera->getExposureAuto().currentValue);
  ...
  ui->horizontalSlider_blacklight->setSliderPosition(
      this->_camera->getBlacklightComp().currentValue);
  ...
  ui->horizontalSlider_white_balance->setSliderPosition(
      this->_camera->getWhiteBalance().currentValue);
  ...
  ui->brightness_default_label->setText(
      QString::number(this->_camera->getBrightness().defaultValue));
  ui->contrast_default_label->setText(QString::number(this->_camera->getContrast().defaultValue));
  ui->saturation_default_label->setText(
      QString::number(this->_camera->getSaturation().defaultValue));
  ui->exposure_default_label->setText(
      QString::number(this->_camera->getExposureAbsolute().defaultValue));
  ui->exposureAuto_default_label->setText(
      QString::number(this->_camera->getExposureAuto().defaultValue));
  ui->blacklight_default_label->setText(
      QString::number(this->_camera->getBlacklightComp().defaultValue));
  ui->white_balance_default_label->setText(
      QString::number(this->_camera->getWhiteBalance().defaultValue));
