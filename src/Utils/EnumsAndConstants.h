...
namespace Constants {
  ...
  // Quantidade maxima de iteracoes anteriosres que serao salvas, TALVEZ PRECISE SER DINAMICO! A
  // CONTRIBUICAO IDEAL DE FRAMES ANTERIORES DEPENDE DA CAMERA E DE OUTROS FATORES
  ...
  enum Compare { LESS = -1, EQUAL, GREATER };

  BETTER_ENUM(Fields, int, INVALID = -1, size3x3, size5x5);

  BETTER_ENUM(Color, int, INVALID = 0, ORANGE, BLUE, YELLOW, RED, GREEN, PINK, CYAN, PURPLE, BROWN);

  enum fieldWall { NONE_WALL, BOTTOM_WALL, UP_WALL, RIGHT_WALL, LEFT_WALL };

  // Agrupamento de todas as cores validas
  static constexpr std::initializer_list<Color::_enumerated> ALL_COLORS{Color::ORANGE,
                                                                        Color::BLUE,
                                                                        Color::YELLOW,
                                                                        Color::RED,
                                                                        Color::GREEN,
  ...
  static constexpr std::initializer_list<Color::_enumerated> TEAM_COLORS{Color::BLUE,
                                                                         Color::YELLOW};

  // Agrupamento que identifica que uma cor eh de robo ou nao
  static constexpr std::initializer_list<Color::_enumerated> ROBOT_COLORS{Color::RED,
                                                                          Color::GREEN,
                                                                          Color::PINK,
                                                                          Color::CYAN,
                                                                          Color::PURPLE,
  ...
  */
  ...
  enum BallArea { INVALID_BALLAREA = -1, FAR, MIDDLE_P, NEAR, MAX_BALLAREA };
   ...
   */
  enum { ROBOT1 = 0, ROBOT2 = 1, ROBOT3 = 2, ADV1 = 3, ADV2 = 4, ADV3 = 5, BALL = 6 };
} // namespace Constants
