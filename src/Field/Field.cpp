...
void Field::set(Point t_size,
  ...
  //------------------
  // m_goalAreaMinX = max().x - goalAreaWidth(); //135     não subtraio offset por que o max já é
  // sem o offset(acredito que esteja errado) m_goalAreaMinY = middle().y - m_goalAreaHeight / 2.0;
  // //30
