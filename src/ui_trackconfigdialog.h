...
public:
    ...
    void setupUi(QDialog *TrackConfigDialog)
    {
        if (TrackConfigDialog->objectName().isEmpty())
            TrackConfigDialog->setObjectName(QStringLiteral("TrackConfigDialog"));
        ...
        verticalSlider__MinSize->setObjectName(QStringLiteral("verticalSlider__MinSize"));
        ...
        verticalSlider__MaxSize->setObjectName(QStringLiteral("verticalSlider__MaxSize"));
        ...
        verticalSlider__MinSizeBall->setObjectName(QStringLiteral("verticalSlider__MinSizeBall"));
        ...
        verticalSlider__MaxSizeBall->setObjectName(QStringLiteral("verticalSlider__MaxSizeBall"));
        ...
        label_MaxSize->setObjectName(QStringLiteral("label_MaxSize"));
        label_MaxSize->setGeometry(QRect(80, 40, 31, 20));
        label_MinBall = new QLabel(frame);
        label_MinBall->setObjectName(QStringLiteral("label_MinBall"));
        label_MinBall->setGeometry(QRect(140, 40, 31, 20));
        label_MaxBall = new QLabel(frame);
        label_MaxBall->setObjectName(QStringLiteral("label_MaxBall"));
        label_MaxBall->setGeometry(QRect(200, 40, 31, 20));
        comboBox_EnemySearch = new QComboBox(frame);
        comboBox_EnemySearch->setObjectName(QStringLiteral("comboBox_EnemySearch"));
        ...
        frame_KMeans->setObjectName(QStringLiteral("frame_KMeans"));
        ...
        verticalSlider_orange->setObjectName(QStringLiteral("verticalSlider_orange"));
        ...
        frame_orange->setObjectName(QStringLiteral("frame_orange"));
        ...
        verticalSlider_blue->setObjectName(QStringLiteral("verticalSlider_blue"));
        ...
        frame_yellow->setObjectName(QStringLiteral("frame_yellow"));
        ...
        verticalSlider_yellow->setObjectName(QStringLiteral("verticalSlider_yellow"));
        ...
        frame_red->setObjectName(QStringLiteral("frame_red"));
        ...
        verticalSlider_red->setObjectName(QStringLiteral("verticalSlider_red"));
        ...
        frame_green->setObjectName(QStringLiteral("frame_green"));
        ...
        verticalSlider_green->setObjectName(QStringLiteral("verticalSlider_green"));
        ...
        frame_pink->setObjectName(QStringLiteral("frame_pink"));
        ...
        label_pink->setObjectName(QStringLiteral("label_pink"));
        ...
        verticalSlider_pink->setObjectName(QStringLiteral("verticalSlider_pink"));
        ...
        frame_light_blue->setObjectName(QStringLiteral("frame_light_blue"));
        ...
        label_light_blue->setObjectName(QStringLiteral("label_light_blue"));
        ...
        verticalSlider_light_blue->setObjectName(QStringLiteral("verticalSlider_light_blue"));
        ...
        frame_purple->setObjectName(QStringLiteral("frame_purple"));
        ...
        label_purple->setObjectName(QStringLiteral("label_purple"));
        ...
        verticalSlider_purple->setObjectName(QStringLiteral("verticalSlider_purple"));
        ...
        frame_unknown->setObjectName(QStringLiteral("frame_unknown"));
        ...
        label_unknown->setObjectName(QStringLiteral("label_unknown"));
        ...
        verticalSlider_unknown->setObjectName(QStringLiteral("verticalSlider_unknown"));
        ...
        frame_default->setObjectName(QStringLiteral("frame_default"));
    ...
    {
        TrackConfigDialog->setWindowTitle(QApplication::translate("TrackConfigDialog", "Dialog", Q_NULLPTR));
        videoLabel->setText(QString());
        QTreeWidgetItem *___qtreewidgetitem = treeWidget->headerItem();
        ___qtreewidgetitem->setText(0, QApplication::translate("TrackConfigDialog", "Track N Detection", Q_NULLPTR));

        const bool __sortingEnabled = treeWidget->isSortingEnabled();
        treeWidget->setSortingEnabled(false);
        QTreeWidgetItem *___qtreewidgetitem1 = treeWidget->topLevelItem(0);
        ___qtreewidgetitem1->setText(0, QApplication::translate("TrackConfigDialog", "Detection", Q_NULLPTR));
        QTreeWidgetItem *___qtreewidgetitem2 = ___qtreewidgetitem1->child(0);
        ___qtreewidgetitem2->setText(0, QApplication::translate("TrackConfigDialog", "WhereAreThose", Q_NULLPTR));
        QTreeWidgetItem *___qtreewidgetitem3 = ___qtreewidgetitem1->child(1);
        ___qtreewidgetitem3->setText(0, QApplication::translate("TrackConfigDialog", "None", Q_NULLPTR));
        QTreeWidgetItem *___qtreewidgetitem4 = treeWidget->topLevelItem(1);
        ___qtreewidgetitem4->setText(0, QApplication::translate("TrackConfigDialog", "Tracking", Q_NULLPTR));
        QTreeWidgetItem *___qtreewidgetitem5 = ___qtreewidgetitem4->child(0);
        ___qtreewidgetitem5->setText(0, QApplication::translate("TrackConfigDialog", "SimpleTracking", Q_NULLPTR));
        QTreeWidgetItem *___qtreewidgetitem6 = ___qtreewidgetitem4->child(1);
        ___qtreewidgetitem6->setText(0, QApplication::translate("TrackConfigDialog", "None", Q_NULLPTR));
        treeWidget->setSortingEnabled(__sortingEnabled);

        label_2->setText(QApplication::translate("TrackConfigDialog", "MinSize", Q_NULLPTR));
        label->setText(QApplication::translate("TrackConfigDialog", "MaxSize", Q_NULLPTR));
        label_3->setText(QApplication::translate("TrackConfigDialog", "MinBall", Q_NULLPTR));
        label_4->setText(QApplication::translate("TrackConfigDialog", "MaxBall", Q_NULLPTR));
        label_MinSize->setText(QApplication::translate("TrackConfigDialog", "000", Q_NULLPTR));
        label_MaxSize->setText(QApplication::translate("TrackConfigDialog", "000", Q_NULLPTR));
        label_MinBall->setText(QApplication::translate("TrackConfigDialog", "000", Q_NULLPTR));
        label_MaxBall->setText(QApplication::translate("TrackConfigDialog", "000", Q_NULLPTR));
        comboBox_EnemySearch->clear();
        comboBox_EnemySearch->insertItems(0, QStringList()
         << QApplication::translate("TrackConfigDialog", "Nothing", Q_NULLPTR)
         << QApplication::translate("TrackConfigDialog", "Primary", Q_NULLPTR)
         << QApplication::translate("TrackConfigDialog", "Secondary", Q_NULLPTR)
         << QApplication::translate("TrackConfigDialog", "Both", Q_NULLPTR)
        );
        pushButton_Reset->setText(QApplication::translate("TrackConfigDialog", "Reset", Q_NULLPTR));
        label_5->setText(QApplication::translate("TrackConfigDialog", "KMeans", Q_NULLPTR));
        label_orange->setText(QApplication::translate("TrackConfigDialog", "0", Q_NULLPTR));
        label_blue->setText(QApplication::translate("TrackConfigDialog", "0", Q_NULLPTR));
        label_yellow->setText(QApplication::translate("TrackConfigDialog", "0", Q_NULLPTR));
        label_red->setText(QApplication::translate("TrackConfigDialog", "0", Q_NULLPTR));
        label_green->setText(QApplication::translate("TrackConfigDialog", "0", Q_NULLPTR));
        label_pink->setText(QApplication::translate("TrackConfigDialog", "0", Q_NULLPTR));
        label_light_blue->setText(QApplication::translate("TrackConfigDialog", "0", Q_NULLPTR));
        label_purple->setText(QApplication::translate("TrackConfigDialog", "0", Q_NULLPTR));
        label_unknown->setText(QApplication::translate("TrackConfigDialog", "0", Q_NULLPTR));
    } // retranslateUi
